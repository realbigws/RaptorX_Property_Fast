...
seqid.all_noprof.txt       : The master output file that combines all single prediction results by no_profile mode.

# ------- single prediction results ----- #
seqid.ss3_noprof.txt       : 3-class secondary structure prediction by no_profile mode.
seqid.ss3_noprof_simp.txt  : A simple summary of 3-class secondary structure prediction by no_profile mode in FASTA format.
seqid.ss8_noprof.txt       : 8-class secondary structure prediction by no_profile mode.
seqid.ss8_noprof_simp.txt  : A simple summary of 8-class secondary structure prediction by no_profile mode in FASTA format.
seqid.acc_noprof.txt       : Solvent accessibility (ACC) prediction by no_profile mode.
seqid.acc_noprof_simp.txt  : A simple summary of solvent accessibility (ACC) prediction by no_profile mode in FASTA format.
seqid.diso_noprof.txt      : Disorder prediction by no_profile mode.
seqid.diso_noprof_simp.txt : A simple summary of disorder prediction by no_profile mode in FASTA format.
#==================================================================
